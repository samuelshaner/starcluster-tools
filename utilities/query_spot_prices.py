...
instance_library_vCPUs = [2, 8, 8, 16, 32, 2, 4, 16, 32, 16, 32, 8, 16, 16, 8, 16, 32, 4, 2, 1, 1, 4, 4, 8, 2, 8, 2, 1, 4, 8, 16, 32, 2, 4, 1, 2, 1, 1]
instance_library_on_demand = [0.13, 0.52, 0.42, 0.84, 1.68, 0.105, 0.21, 1.05, 2.00, 2.1, 3.5, 0.65, 3.1, 4.6, 1.705, 3.410, 6.820, 0.853, 0.175, 0.087, 0.044, 0.35, 0.49, 0.98, 0.245, 0.56, 0.14, 0.07, 0.28, 0.7, 1.4, 2.8, 0.175, 0.35, 0.02, 0.052, 0.013, 0.026] 
...
ax = plt.subplot(111)
w = 0.2
#ax.bar(np.arange(num_instances), sentiment_matrix_temp[word_1:word_2,0], width=w, color='r',align='center')
#ax.bar(np.arange(num_instances)+w, sentiment_matrix_temp[word_1:word_2,1], width=w, color='b',align='center')
